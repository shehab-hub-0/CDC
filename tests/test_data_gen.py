...
def test_generate_transaction_schema():
    ...
    required_keys = [
        "transactionId", "userId", "timestamp", "amount", 
        "currency", "city", "country", "merchantName", 
        "paymentMethod", "ipAddress", "transaction_type", "phone_number"
    ]
...
def test_generate_transaction_values():
    ...
    assert tx["transaction_type"] in ["DEPOSIT", "WITHDRAWAL", "PAYMENT", "TRANSFER"], "Invalid transaction type"
